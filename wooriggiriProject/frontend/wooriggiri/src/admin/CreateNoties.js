...
import styles from './styles/createNoties.module.css'
import { useAuth } from '../contexts/AuthContext.js';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';

function CreateNoties() {
    ...
    function InsertPost() {
        ...
        const fetch = async () => {
            const response = await axios.post(`http://localhost:8080/authapi/insertnoties`,
                {
                    userId,
                    title,
                    content
